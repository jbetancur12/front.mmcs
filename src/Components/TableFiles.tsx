// @ts-nocheck
import { Cancel, CheckCircle, CloudUpload, Delete, FileDownload, Warning } from '@mui/icons-material';
import {
  Box,
  Button,
  Dialog,
        ...
        Cell: ({ cell, row }) => {
          ...
          return (
            <div className="flex flex-col ">
              ...
              <span className={`mt-2 ${daysRemaining < 0 ? 'text-red-500 font-bold' : ''}`}>{daysRemaining < 0 ? 'VENCIDO' : `Días restantes: ${daysRemaining}`}</span>
            </div>
          );
...
export const CreateNewAccountModal = ({
  ...
  const handleRadioChange = (event, accessorKey) => {
    ...
    let newDate = values.calibrationDate !== "" ? new Date(values.calibrationDate) : new Date();
  ...
  const handleChangeCalibrationDate = (e, accessorKey) => {
    ...
    // Actualiza el estado con la nueva fecha
    setValues({ ...values, ["nextCalibrationDate"]: newDate, [accessorKey]: new Date(e) });
                  ...
                  case "date":
                    return (
                      <DatePicker
                        ...
                        onChange={(e) => handleChangeCalibrationDate(e, column.accessorKey)}
                      />
                        ...
                        <div class="flex justify-start mt-0">
                          ...
                          <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                            <input
                              ...
                              onChange={(e) => handleRadioChange(e, column.accessorKey)}
                              />
                            <label
